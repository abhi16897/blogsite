     ...
     <div class=" container container-body">
         <div class="row">
             ...
             <div class="col-md-10">
               ...
               <a href="<?php echo base_url();?>Edit/readmore/<?php echo $p->id;?>">Read More</a>
               <a href="<?php echo base_url();?>Edit/edit/<?php echo $p->id ;?>">Edit</a>
               <a href="<?php echo base_url();?>Edit/delete/<?php echo $p->id ;?>">Delete</a>
             </div>
        </div>
    </div>
<?php }
